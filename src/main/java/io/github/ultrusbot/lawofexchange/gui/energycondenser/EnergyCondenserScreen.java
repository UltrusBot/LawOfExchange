...
public class EnergyCondenserScreen extends HandledScreen<EnergyCondenserScreenHandler> {
    private static final Identifier TEXTURE = new Identifier(LawOfExchangeMod.MOD_ID, "textures/gui/energy_condenser.png");
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        int emc = this.getScreenHandler().getEMC();
        this.textRenderer.draw(matrices, Text.of("EMC: " + emc), this.x + this.backgroundWidth/8.0f, this.y + 5, 4210752);
