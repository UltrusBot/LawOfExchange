package io.github.ultrusbot.lawofexchange.block.furnace;

import io.github.ultrusbot.lawofexchange.block.entity.AbstractEMCFurnaceBlockEntity;
...
public abstract class AbstractEMCFurnaceBlock extends BlockWithEntity {
    public static final DirectionProperty FACING;
    public static final BooleanProperty LIT;

    protected AbstractEMCFurnaceBlock(AbstractBlock.Settings settings) {
        super(settings);
